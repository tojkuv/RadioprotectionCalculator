namespace RadioprotectionCalculator.Client.Models
{
    public class IsotopeDecay
    {
        ...
        public Units.ActivityUnit ActivityUnit { get; set; } = Units.ActivityUnit.mCi;
        ...
        public DateTime? OriginalDate { get; set; } = new();
        public TimeSpan? OriginalTime { get; set; } = new();
        public DateTime? CalculationDate { get; set; } = new();
        public TimeSpan? CalculationTime { get; set; } = new();
        public static Dictionary<string, List<Isotope>> Isotopes { get; set; } = new Dictionary<string, List<Isotope>>
            {
                { "Fluorine (F)", new List<Isotope> { new Isotope { Name = "F-18", HalfLife = TimeSpan.FromMinutes(18), PreferredHalfLifeUnit = Units.TimeUnit.Minutes }, new Isotope { Name = "F-19", HalfLife = TimeSpan.FromMinutes(19), PreferredHalfLifeUnit = Units.TimeUnit.Minutes } } },
